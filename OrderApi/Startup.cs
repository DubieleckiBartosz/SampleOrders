...
using OrderApi.ConfigExtensions;
using System;
...
namespace OrderApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                services.GetClientBackgroundService();
                services.GetRedis(redisSettings.Connection);
            }

            services.GetHttpClient();
            services.GetRabbitMq(Configuration);
